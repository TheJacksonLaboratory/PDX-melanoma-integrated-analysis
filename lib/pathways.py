...
genesDicts.update({'HOEK_INVASIVE': ['DCT', 'GPR143', 'MATP', 'MLANA', 'SILV', 'TRPM1', 'TYR', 'TYRP1', 'EDNRB', 'ERBB3', 'MBP', 'MITF', 'PLP1', 'BGN', 'CDH2', 'COL5A1', 'CTGF', 'FBN1', 'FGF2', 'IL6', 'INHBA', 'LOX', 'SERPINE1', 'TAGLN', 'TGFBI', 'THBS1', 'TNFRSF11B', 'TPM1', 'TPM2']})
...
genesDicts.update({'WP_OREXIN':['ADIPOQ','ARRB1','ARRB2','BGLAP','BMP7','BMPR1A','CAMKK2','CASP3','CASP9','CCK','CGA','CREB1','CXCL2','CXCL8','DAGLA','DYNLT1','DYNLT3','EIF4B','EIF4EBP1','FOXO1','FSHB','GCG','GH1','GHRL','GNA11','GNAI1','GNAQ','GNAS','GNRH1','GRIA1','HCRT','HCRTR1','HCRTR2','HIF1A','IL10','IL1B','IL4','IL6','IL9','LEP','LHB','MAP2K1','MAP2K2','MAPK1','MAPK14','MAPK3','MAPK7','MAPK8','MAPK9','MTOR','NFE2L2','NOX4','NPFFR1','NPVF','NPY','OPRK1','PDHB','PDK1','PDPK1','PIK3R1','PIK3R2','PLCD1','PLD1','POMC','PRKAA1','PRKCA','PRKCB','PRKCD','PRKCE','PRKCZ','PRKD1','PTPN11','RPS6','RPS6KA1','RPS6KB1','RRAGC','RUNX2','SGK1','SLC1A2','SLC2A1','SLC2A4','SMAD1','SMAD5','STAR','STAT3','TH','TNF','VHL']})
